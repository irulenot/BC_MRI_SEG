...
def main():
    data_path = 'D:/data/RIDER/rider_data.npy'
    meta_data_path = 'D:/data/RIDER/rider_meta_data.pkl'
    ...
    print('RIDER MRI DATASET STATISTICS')
    ...
    print(f'Mean: {mean1:.2f}, Std: {std1:.2f}, Range: {range1}, Mode: {mode1}')
    print()
